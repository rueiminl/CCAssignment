...
public class Solution107 {
	public static void main(String[] args) {
		...
		myImplementation += "Similar solution, I would check 4G/10M = 400 iteration; the first iteration check the range from 0 to 10 million; the second iteration check the range from 10 million to 20 million; and so on.\n";
